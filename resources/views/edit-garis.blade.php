...
@section('content')
    ...
    <!-- Modal Edit Garis-->
    <div class="modal fade" id="editGarisModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Garis</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="{{ route('gariss.update', $id) }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="color_garis" name="color" value="">
...
@section('scripts')
    ...
    <script>
        ...
        function initColorSelection() {
            ...
            const colorInput = document.querySelector('#color_garis');
            const previewColor = document.querySelector('#preview-color-garis');
            const colorName = document.querySelector('#color-name-garis');
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                $('#preview-image-garis').attr('src', "{{ asset('storage/images') }}/" + properties
                    .image);

                // Set color if available
                if (properties.color) {
                    $('#color_garis').val(properties.color);
                    $('#preview-color-garis').css('background-color', properties.color);
                    $('#color-name-garis').text(colorNames[properties.color] || 'Custom');
    ...
    <script>
        ...
        var garis = L.geoJson(null, {
            ...
            onEachFeature: function(feature, layer) {
                // memasukkan layer garis ke dalam drawnItems
                drawnItems.addLayer(layer);
                ...
                layer.on({
                    click: function(e) {
                        ...
                        $('#geom_garis').val(objectGeometry);
                        $('#preview-image-garis').attr('src', "{{ asset('storage/images') }}/" +
                            feature.properties.image);

                        // Set color if available
                        if (feature.properties.color) {
                            $('#color_garis').val(feature.properties.color);
                            $('#preview-color-garis').css('background-color', feature.properties
                                .color);
                            $('#color-name-garis').text(colorNames[feature.properties.color] ||
                                'Custom');
                            ...
                            $('#color_garis').val('#FF0000');
                            $('#preview-color-garis').css('background-color', '#FF0000');
                            $('#color-name-garis').text('Red');
                        }
