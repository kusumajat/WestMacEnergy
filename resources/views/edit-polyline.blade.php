                ...
                <form method="POST" action="{{ route('polylines.update', $id) }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="color_polyline" name="color" value="">
...
@section('scripts')
    ...
    <script>
        ...
        function initColorSelection() {
            ...
            const colorInput = document.querySelector('#color_polyline');
            const previewColor = document.querySelector('#preview-color-polyline');
            const colorName = document.querySelector('#color-name-polyline');
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                if (properties.color) {
                    $('#color_polyline').val(properties.color);
                    $('#preview-color-polyline').css('background-color', properties.color);
                    $('#color-name-polyline').text(colorNames[properties.color] || 'Custom');
    ...
    <script>
                ...
                layer.on({
                    click: function(e) {
                        ...
                        if (feature.properties.color) {
                            $('#color_polyline').val(feature.properties.color);
                            $('#preview-color-polyline').css('background-color', feature.properties
                                .color);
                            $('#color-name-polyline').text(colorNames[feature.properties.color] ||
                                'Custom');
                            ...
                            $('#color_polyline').val('#FF0000');
                            $('#preview-color-polyline').css('background-color', '#FF0000');
                            $('#color-name-polyline').text('Red');
                        }
        ...
        // Function to edit polyline (called from popup)
        function editPolyline(polylineId) {
