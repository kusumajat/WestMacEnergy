...
@section('content')
    ...
    <!-- Modal Edit Titik-->
    <div class="modal fade" id="editTitikModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Titik</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="{{ route('titiks.update', $id) }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="color_titik" name="color" value="">
                        ...
                        <img src="" alt="" id="preview-image-titik" class="img-thumbnail" width="400">
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function initColorSelection() {
            ...
            const colorInput = document.querySelector('#color_titik');
            const previewColor = document.querySelector('#preview-color-titik');
            const colorName = document.querySelector('#color-name-titik');
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                $('#preview-image-titik').attr('src', "{{ asset('storage/images') }}/"+ properties.image);

                // Set color if available
                if (properties.color) {
                    $('#color_titik').val(properties.color);
                    $('#preview-color-titik').css('background-color', properties.color);
                    $('#color-name-titik').text(colorNames[properties.color] || 'Custom');
    ...
    <script>
        ...
        var titik = L.geoJson(null, {
            ...
            onEachFeature: function(feature, layer) {
                // memasukkan layer titik ke dalam drawnItems
                drawnItems.addLayer(layer);
                ...
                layer.on({
                    click: function(e) {
                        ...
                        $('#geom_titik').val(objectGeometry);
                        $('#preview-image-titik').attr('src', "{{ asset('storage/images') }}/"+ feature.properties.image);

                        // Set color if available
                        if (feature.properties.color) {
                            $('#color_titik').val(feature.properties.color);
                            $('#preview-color-titik').css('background-color', feature.properties.color);
                            $('#color-name-titik').text(colorNames[feature.properties.color] || 'Custom');
                            ...
                            $('#color_titik').val('#FF0000');
                            $('#preview-color-titik').css('background-color', '#FF0000');
                            $('#color-name-titik').text('Red');
                        }
