...
class TitiksController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // validate data
        $request->validate([
            'name' => 'required|unique:titiks,name',
        ...
        [
            ...
            'geom_titik.required' => 'Geometry is required',
        ]);
        ...
        if ($request->hasFile('image')) {
            ...
            $name_image = time() . "_titik." . strtolower($image->getClientOriginalExtension());
    ...
    public function update(Request $request, string $id)
    {
        ...
        $request->validate(
            [
                'name' => 'required|unique:titiks,name,' . $id,
                'description' => 'required',
                'geom_titik' => 'required',
            ...
            [
                ...
                'description.required' => 'Description is required',
                'geom_titik.required' => 'Titik is required',
            ]
        );
        ...
        // Get old image
        $old_image = $this->titiks->find($id)->image;
